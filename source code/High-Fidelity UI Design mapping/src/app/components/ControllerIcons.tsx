...
export function DPadUp() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M12 8L12 16M8 12L16 12" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
      <path d="M12 8L12 10" stroke="#06b6d4" strokeWidth="2.5" strokeLinecap="round"/>
    </svg>
  );
}
...
export function DPadDown() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M12 8L12 16M8 12L16 12" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
      <path d="M12 14L12 16" stroke="#06b6d4" strokeWidth="2.5" strokeLinecap="round"/>
    </svg>
  );
}
...
export function DPadLeft() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M12 8L12 16M8 12L16 12" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
      <path d="M8 12L10 12" stroke="#06b6d4" strokeWidth="2.5" strokeLinecap="round"/>
    </svg>
  );
}
...
export function DPadRight() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M12 8L12 16M8 12L16 12" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
      <path d="M14 12L16 12" stroke="#06b6d4" strokeWidth="2.5" strokeLinecap="round"/>
    </svg>
  );
}
